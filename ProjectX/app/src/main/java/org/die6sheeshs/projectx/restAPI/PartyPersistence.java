...
public class PartyPersistence implements RetrofitPersistence {
    ...
    public Observable<Party> createParty(String name, String description, LocalDateTime start, LocalDateTime end, int max_people, EventLocation eventLocation) {

        Party p = new Party(name, description, start, end, max_people, eventLocation);
