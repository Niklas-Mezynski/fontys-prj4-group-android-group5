...
import {Event, EventRelations, Pictures, EventLocation, Ticket, User, TicketRequest} from '../models';
...
> {
  ...
  public readonly ticketRequests: HasManyRepositoryFactory<TicketRequest, typeof Event.prototype.id>;
